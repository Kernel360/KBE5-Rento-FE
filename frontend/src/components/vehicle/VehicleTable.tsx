...
const VehicleTable: React.FC<VehicleTableProps> = ({ vehicles, sortConfig, setSortConfig }) => {
              ...
              <tr key={index} className="hover:bg-gray-50 cursor-pointer">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  {vehicle.status === 'available' ? (
                    ...
                    <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-orange-100 text-orange-800">사용중</span>
                  )}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <button className="text-green-600 hover:text-green-900 mr-3 cursor-pointer whitespace-nowrap !rounded-button">
                    <i className="fas fa-edit"></i>
                  </button>
                  <button className="text-red-600 hover:text-red-900 cursor-pointer whitespace-nowrap !rounded-button">
